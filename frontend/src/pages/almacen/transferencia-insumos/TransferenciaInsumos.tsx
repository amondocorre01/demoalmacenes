...
const availableWarehouses = ['Supervision', 'Pies', 'Bizcochos', 'Panadería', 'Tortas'];
const availableInsumosList = [
...
const TransferenciaInsumos: React.FC = () => {
  ...
  const handleAddProduct = (product: any) => {
    ...
    if (transferItems.find(item => item.name === product.name)) {
      setSnackbar({ open: true, message: 'El insumo ya está en la lista', severity: 'error' });
      return;
    }
  ...
  const handleSaveTransfer = () => {
    if (!sourceWarehouse || !targetWarehouse || transferItems.length === 0) {
      setSnackbar({ open: true, message: 'Complete todos los datos y añada insumos', severity: 'error' });
      return;
    }
    ...
    setSnackbar({ open: true, message: 'Transferencia de insumos registrada', severity: 'success' });
  ...
  return (
    <div className="max-w-7xl mx-auto py-10 px-6 sm:px-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
        <div>
          <p className="text-4xl font-black tracking-tighter text-zinc-900 uppercase leading-none">Transferencia de Insumos</p>
          <p className="text-zinc-400 font-bold uppercase text-xs tracking-widest mt-2">Gestión y registro de movimientos de materia prima entre almacenes.</p>
        </div>
        <button 
      ...
      <div className="mb-10 bg-white border border-zinc-100 rounded-[2.5rem] p-8 shadow-sm">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <label className="block text-[10px] font-black text-zinc-400 tracking-widest uppercase mb-2 ml-1">Filtrar Almacén</label>
            <Autocomplete
      ...
      <div className="bg-white border border-zinc-100 rounded-[3rem] overflow-hidden shadow-sm">
        <div className="p-8 md:p-10 border-b border-zinc-50 bg-zinc-50/20">
          <p className="text-xs font-black text-zinc-800 uppercase tracking-[0.2em]">Historial de Transferencias</p>
        </div>
        ...
        <DialogTitle sx={{ p: 2, px: 4, bgcolor: 'white', borderBottom: '1px solid', borderColor: 'zinc-50' }}>
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-[9px] font-black text-primary uppercase tracking-[0.2em]">Suministros Internos</p>
        ...
        <DialogContent sx={{ p: 4, bgcolor: 'white' }}>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-4 mb-10 items-end">
            <div className="space-y-2">
              ...
              <Autocomplete
                ...
                renderInput={(params) => <TextField {...params} size="small" placeholder="Origen..." sx={{ '& .MuiOutlinedInput-root': { borderRadius: '16px' } }} />}
              />
            </div>
            <div className="space-y-2">
              ...
              <Autocomplete
                ...
                renderInput={(params) => <TextField {...params} size="small" placeholder="Destino..." sx={{ '& .MuiOutlinedInput-root': { borderRadius: '16px' } }} />}
              />
            </div>
            <div className="space-y-2">
              <label className="text-[10px] font-black text-zinc-400 uppercase tracking-widest ml-1">Buscar Insumo</label>
              <Autocomplete
                options={availableInsumosList}
          ...
          <div className="bg-zinc-50/50 rounded-[2rem] border border-zinc-100 overflow-hidden">
            <div className="px-8 py-4 border-b border-zinc-100 bg-zinc-50/80">
              <p className="text-[10px] font-black text-zinc-800 uppercase tracking-[0.2em]">Detalle de Insumos</p>
            </div>
              ...
              <table className="w-full text-left border-collapse min-w-[800px]">
                <thead>
                  <tr className="bg-white/50 text-[9px] font-black uppercase tracking-[0.2em] text-zinc-400 border-b border-zinc-100">
                    <td className="px-8 py-4">Insumo</td>
                  ...
                  {transferItems.length === 0 ? (
                    <tr>
                      <td colSpan={5} className="px-8 py-10 text-center text-[10px] font-black text-zinc-300 uppercase tracking-widest">
                        Utilice el buscador arriba para añadir insumos al listado
                      </td>
                    </tr>
                  ) : (
